...
Billing-only migrations have HIGHER one-time costs due to unknowns:

```
Component                        Low      High     Note
-------------------------------------------------------------
Discovery refinement (IaC scan)  $2,000   $5,000   Recommended to reduce unknowns
Architecture design              $3,000   $8,000   More effort without source config
Code migration                   $5,000   $15,000  Depends on actual complexity
Testing & validation             $3,000   $10,000  More testing needed
Data migration                   $1,000   $5,000   Depends on volume
-------------------------------------------------------------
TOTAL One-Time                   $14,000  $43,000
```
