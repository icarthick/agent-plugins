...
| db.r8g.4xlarge | 2.872  |
| db.r8g.8xlarge | 5.744  |
...
| Instance      | $/hour | $/month |
| ------------- | ------ | ------- |
| db.t3.small   | 0.017  | 12.41   |
| db.t3.medium  | 0.034  | 24.81   |
| db.t3.large   | 0.068  | 49.63   |
| db.t4g.micro  | 0.016  | 11.68   |
| db.t4g.small  | 0.032  | 23.36   |
| db.t4g.medium | 0.065  | 47.45   |
| db.m5.large   | 0.251  | 183.23  |
...
Prices per 1M tokens. Prompt caching available for Claude models (90% reduction on cached portions).
...
| Nova Premier      | amazon.nova-premier-v1:0                 | Amazon    | 2.40       | 9.60        | 1M      | reasoning |
| Mistral Large 3   | mistral.mistral-large-3-675b-instruct    | Mistral   | 2.00       | 6.00        | 128K    | flagship  |
...
| ---------------------- | ---------- | ----------- | ------- | -------- |
| Gemini 3.1 Pro Preview | 1.25       | 10.00       | 1M      | flagship |
